defmodule HorizonSdk.ApiBehavior do
  ...
  # space
  @callback get_space(id :: integer(), adapter :: APIAdapterState.t()) :: {:ok, result :: map(), adapter :: APIAdapterState.t()}

  @callback update_space!(space_id :: integer(), payload :: map(), user :: map(), adapter :: APIAdapterState.t()) :: {:ok, map(), APIAdapterState.t()}  

  # place
  @callback create_place(payload :: map(), adapter :: APIAdapterState.t()) :: {:ok, map(), APIAdapterState.t()}
  @callback create_place_from_feature!(feature_params :: map(), user :: map(), adapter :: APIAdapterState.t()) :: {:ok, map(), APIAdapterState.t()}

  @callback update_place!(place_id :: integer(), payload :: map(), user :: map(), adapter :: APIAdapterState.t()) :: {:ok, map(), APIAdapterState.t()}
  @callback update_place(id :: integer(), payload :: map(), adapter :: APIAdapterState.t()) :: :ok
  @callback update_place_from_feature!(place :: map(), feature_params :: map(), user_id :: integer(), adapter :: APIAdapterState.t()) :: map()

  @callback delete_place!(place :: map(), user :: map(), adapter :: APIAdapterState.t()) :: {:ok, APIAdapterState.t()}
  ...
  @callback get_layer(id :: integer(), user_id :: integer, adapter :: APIAdapterState.t()) :: {:ok, result :: map()}
  @callback get_layers(ids :: list(integer()), adapter :: APIAdapterState.t()) :: {:ok, result :: map()}
  @callback get_with_layer_places(layer_id :: integer(), adapter :: APIAdapterState.t()) :: map()
 
  @callback set_layer_symbol(layer_id :: integer(), payload :: map(), adapter :: APIAdapterState.t()) :: :ok

  @callback set_layer_3d(layer_id :: integer(), payload :: map(), adapter :: APIAdapterState.t()) :: :ok

  # data
  @callback update_place_data(place_id :: integer(), payload :: map(), adapter :: APIAdapterState.t()) :: :ok

  @callback update_layer_data(layer_id :: integer(), payload :: map(), adapter :: APIAdapterState.t()) :: :ok

  @callback update_space_data(space_id :: integer(), payload :: map(), adapter :: APIAdapterState.t()) :: :ok
  
  # map visual
  @callback set_color(adapter :: APIAdapterState.t()) :: :ok
  @callback set_size(adapter :: APIAdapterState.t()) :: :ok

  @callback update_circle_radius(layer_id :: integer, value :: integer(), adapter :: APIAdapterState.t()) :: :ok
  ...
  # blocks
  @callback update_block_content(id :: integer(), payload :: map(), adapter :: APIAdapterState.t()) :: :ok
  @callback update_block_property(id :: integer(), payload :: map(), adapter :: APIAdapterState.t()) :: :ok

  # tooltip
  @callback set_tooltip(String.t(), adapter :: APIAdapterState.t()) :: :ok

  # space plugin
  @callback get_space_plugin_by_space_id_plugin_id(space_id :: integer(), plugin_id :: integer(), adapter :: APIAdapterState.t()) :: {:ok, result :: map(), APIAdapterState.t()}
